    ...
    public class Socks5 : IDisposable
    {
        ...
        public Socks5 (Factories factories, IPEndPoint socksServerEndPoint, byte[] username, byte[] password)
        {
            ...
            Factories = factories
                ...
                .WithTrackerCreator ("http", uri => new MonoTorrent.Trackers.Tracker (new HttpTrackerConnection (uri, httpClientCreator ())))
                .WithTrackerCreator ("https", uri => new MonoTorrent.Trackers.Tracker (new HttpTrackerConnection (uri, httpClientCreator ())))
